<template>
  <div class="freeboard">
    <v-card background-color="#f9fcfc" outlined color="#f9fcfc">
      ...
      <v-data-table color="table" :headers="headers" :items="notice_items" :search="search"></v-data-table>
    </v-card>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "작성일", sortable: false, value: "date" },
      { text: "작성자", sortable: false, value: "writer", width: "11%" },
      { text: "조회수", sortable: false, value: "hits" }
    ],
    notice_items: [
      {
        title: "첫 게시글입니다.",
